...
// Menghitung durasi dari tanggal mulai sampai tanggal selesai
$tanggal_mulai = strtotime($rental['tanggal_mulai']);
$tanggal_selesai = strtotime($rental['tanggal_selesai']);
$durasi = ($tanggal_selesai - $tanggal_mulai) / (60 * 60 * 24); // Menghitung dalam hari
?>
                    ...
                    <div class="bg-gray-50 p-6 rounded-lg">
                        ...
                        <dl class="grid grid-cols-1 gap-4">
                            ...
                            <div>
                                ...
                                <dd class="mt-1"><?php echo $durasi; ?> hari</dd>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <dd class="mt-1"><?php echo isset($rental['catatan']) ? nl2br(htmlspecialchars($rental['catatan'])) : 'Tidak ada catatan.'; ?></dd>
                            </div>
                        </dl>
